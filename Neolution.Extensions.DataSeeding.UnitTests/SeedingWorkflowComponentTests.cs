namespace Neolution.Extensions.DataSeeding.UnitTests
{
    ...
    public class SeedingWorkflowComponentTests
    {
        ...
        public async Task SeedExecution_ResolvesSeedsWithCorrectConcreteTypes()
        {
            ...
            // Assert
            concreteSeedTypes.ShouldContain(typeof(WorkflowTestSeed));
            concreteSeedTypes.ShouldNotBeEmpty();
        ...
        public void ServiceRegistration_IncludesBothInterfaceAndConcreteTypes()
        {
            ...
            var workflowSeedAsInterface = serviceProvider.GetServices<ISeed>()
                .FirstOrDefault(s => s.GetType() == typeof(WorkflowTestSeed));
            var workflowSeedAsConcrete = serviceProvider.GetService<WorkflowTestSeed>();
            ...
            workflowSeedAsInterface.ShouldBeOfType<WorkflowTestSeed>();
            workflowSeedAsConcrete.ShouldBeOfType<WorkflowTestSeed>();
        }
        ...
        private IServiceCollection CreateServiceCollection()
        {
            ...
            services.AddLogging(builder => builder.AddXUnit(this.testOutputHelper).SetMinimumLevel(LogLevel.Trace));

            // Register all service lifetimes to test comprehensive scenarios
